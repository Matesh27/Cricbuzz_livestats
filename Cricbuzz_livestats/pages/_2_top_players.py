...
#     """
#     Convert Cricbuzz 'headers' + 'values' JSON into a pandas DataFrame.
...
#     except Exception:
#         # swallow network/parse errors and return None
#         return None
#     return None
...
#     section may be:
#       - None
#       - a list like [{...}]  -> we take first dict
#       - a dict directly
#     Return a dict with keys 'test', 'odi', 't20' (values or 'N/A').
#     """
#     if not section:
...
#     """
#     Returns (bat_rank_dict, bowl_rank_dict). Each dict has keys 'test','odi','t20'.
#     Handles many possible shapes returned by the API.
#     """
...
#     # sometimes Cricbuzz puts summary in 'all' or other places; try fallback
...
#     player_name = st.text_input("🔍 Enter Player Name", placeholder="e.g., Usman Khawaja")
#     if not player_name:
...
#     # show bowling ranks only if any exist (not all players are bowlers)
